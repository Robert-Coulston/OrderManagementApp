...
export type MutationAddOrUpdateCustomerArgs = {
  customerModel: CustomerModelInput;
};


export type MutationAddOrUpdateOrderArgs = {
  orderModel: OrderModelInput;
};
...
export type AddOrUpdateOrderMutation = { __typename?: 'Mutation', addOrUpdateOrder: { __typename?: 'Order', id: number, orderDate: any, depositAmount: any, totalAmount: any, customerId: number, description?: string | null, isDelivery: boolean, status: Status, otherNotes?: string | null, customer?: { __typename?: 'Customer', id: number, firstName?: string | null, lastName?: string | null, contactNumber?: string | null, email?: string | null } | null } };
...
export const AddOrUpdateCustomerDocument = gql`
    mutation AddOrUpdateCustomer($customerModel: CustomerModelInput!) {
  addOrUpdateCustomer(customerModel: $customerModel) {
    id
    firstName
    lastName
    email
 ...
 *   variables: {
 *      customerModel: // value for 'customerModel'
 *   },
 * });
 */
 ...
 *   variables: {
 *      orderModel: // value for 'orderModel'
 *   },
 * });
 */
